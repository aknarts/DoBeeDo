 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const B=globalThis,Y=B.trustedTypes,at=Y?Y.createPolicy("lit-html",{createHTML:o=>o}):void 0,nt="$lit$",x=`lit$${Math.random().toFixed(9).slice(2)}$`,dt="?"+x,Et=`<${dt}>`,w=document,M=()=>w.createComment(""),N=o=>o===null||typeof o!="object"&&typeof o!="function",Z=Array.isArray,Ct=o=>Z(o)||typeof(o==null?void 0:o[Symbol.iterator])=="function",X=`[ 	
